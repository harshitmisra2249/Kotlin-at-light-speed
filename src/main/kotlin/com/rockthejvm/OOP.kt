...
object OOP {
    ...
    // abstract class: method of Defining functions without implementation
    abstract class WalkingPet {
        val hasLegs = true
        abstract fun walk(): Unit // may not necessarily have an implementation
    }

    // interface- Just like Java interface is said to be ultimate abstract type
    //in interfaces we do not need to define functions as abstract whatever functions
    // we use in interface is automatically abstract
    interface Carnivore {
    ...
    // overloading: we can define multiple  methods with differennt signatures or different argument lists
    // in the same class
    ...
    // generics allow reusability of code
